...
import com.example.craftzone.databinding.FragmentPvcWoodenFlooringBinding
import com.example.craftzone.fragments.bottomNavigation.HomeFragment
import com.google.firebase.firestore.FirebaseFirestore

class pvc_wooden_flooring : Fragment() {
    private lateinit var binding: FragmentPvcWoodenFlooringBinding
    private lateinit var firebaseFirestore: FirebaseFirestore
    private lateinit var adapter: pvcwoodenflooringAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentPvcWoodenFlooringBinding.inflate(inflater, container, false)
    ...
    private fun initVars() {
        ...
        adapter = pvcwoodenflooringAdapter(ArrayList())
