...
import com.example.craftzone.databinding.FragmentGenuineLeatherBinding
import com.example.craftzone.fragments.bottomNavigation.HomeFragment
import com.google.firebase.firestore.FirebaseFirestore

class genuine_leather : Fragment() {
    private lateinit var binding: FragmentGenuineLeatherBinding
    private lateinit var firebaseFirestore: FirebaseFirestore
    private lateinit var adapter: genuine_leatherAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentGenuineLeatherBinding.inflate(inflater, container, false)
    ...
    private fun initVars() {
        ...
        adapter = genuine_leatherAdapter(ArrayList())
