...
import com.example.craftzone.databinding.FragmentReclinerBinding
import com.example.craftzone.fragments.bottomNavigation.HomeFragment
import com.google.firebase.firestore.FirebaseFirestore

class recliner : Fragment() {
    private lateinit var binding: FragmentReclinerBinding
    private lateinit var firebaseFirestore: FirebaseFirestore
    private lateinit var adapter: reclinerAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentReclinerBinding.inflate(inflater, container, false)
    ...
    private fun initVars() {
        ...
        adapter = reclinerAdapter(ArrayList())
