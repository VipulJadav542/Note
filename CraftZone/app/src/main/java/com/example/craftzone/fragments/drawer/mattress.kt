...
import com.example.craftzone.databinding.FragmentMattressBinding
import com.example.craftzone.fragments.bottomNavigation.HomeFragment
import com.google.firebase.firestore.FirebaseFirestore

class mattress : Fragment() {
    private lateinit var binding: FragmentMattressBinding
    private lateinit var firebaseFirestore: FirebaseFirestore
    private lateinit var adapter: mattressAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentMattressBinding.inflate(inflater, container, false)
    ...
    private fun initVars() {
        ...
        adapter = mattressAdapter(ArrayList())
