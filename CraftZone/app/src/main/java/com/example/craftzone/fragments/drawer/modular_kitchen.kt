...
import com.example.craftzone.databinding.FragmentModularKitchenBinding
import com.example.craftzone.fragments.bottomNavigation.HomeFragment
import com.google.firebase.firestore.FirebaseFirestore

class modular_kitchen : Fragment() {
    private lateinit var binding: FragmentModularKitchenBinding
    private lateinit var firebaseFirestore: FirebaseFirestore
    private lateinit var adapter: modular_kitchenAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentModularKitchenBinding.inflate(inflater, container, false)
    ...
    private fun initVars() {
        ...
        adapter = modular_kitchenAdapter(ArrayList())
