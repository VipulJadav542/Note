...
import com.example.craftzone.databinding.FragmentUpholsteryBedBinding
import com.example.craftzone.fragments.bottomNavigation.HomeFragment
import com.google.firebase.firestore.FirebaseFirestore

class upholstery_bed : Fragment() {
    private lateinit var binding: FragmentUpholsteryBedBinding
    private lateinit var firebaseFirestore: FirebaseFirestore
    private lateinit var adapter: upholstery_bedAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentUpholsteryBedBinding.inflate(inflater, container, false)
    ...
    private fun initVars() {
        ...
        adapter = upholstery_bedAdapter(ArrayList())
